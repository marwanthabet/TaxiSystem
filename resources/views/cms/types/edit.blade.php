...
@section('page-large-title','Edit Type')
    ...
    <div class="row">
      ...
      <div class="col-md-10">
        ...
        <div class="card card-info">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form class="form-horizontal" method="POST" action="{{route('car-types.update', $type->id)}}">
            @method('PUT')
            <div class="card-body">
              @csrf
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  ...
                  @if (old('name')) value="{{old('name')}}" @else value="{{$type->name}}" @endif placeholder="Name">
                </div>
              </div>
